...
const avatars = [
  "https://images.unsplash.com/photo-1552234994-66ba234fd567?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1551103782-8ab07afd45c1?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
              ...
              <div className="px-2 flex flex-col flex-1">
                ...
                <div className="flex items-center justify-between mt-auto">
                  <Link 
                    ...
                    className="block"
                  >
                    <div className="bg-[#0f0f11] text-white text-xs font-semibold px-5 py-2.5 rounded-lg hover:bg-black/80 transition-all hover:-translate-y-[4px]">
                      Enroll now
                    </div>
                  </Link>
