...
import { FiClock, FiBookOpen, FiBarChart2, FiDatabase, FiFilter, FiArrowRight } from "react-icons/fi";
import { FaPiggyBank } from "react-icons/fa";

const courses = [
  {
    title: "Real Estate Investing Secrets",
    icon: <FiDatabase className="text-5xl opacity-80" />,
    color: "bg-[#5b61d6]", // Purple/Blue
    hours: "96 hours",
    sections: "48 sections",
    level: "Expert level",
    description: "Learn how to evaluate properties, analyze market trends, negotiate deals and finance investments.",
    price: "$ 209.00",
    enrolled: "312 enrolled",
  },
  {
    title: "Retirement Planning Made Easy",
    icon: <FaPiggyBank className="text-5xl opacity-80" />,
    color: "bg-[#55e0b6]", // Teal
    hours: "20 hours",
    sections: "11 sections",
    level: "Beginner level",
    description: "Understand different retirement accounts, estimate retirement needs and optimize savings.",
    price: "$ 69.00",
    enrolled: "155 enrolled",
  },
  {
    title: "Passive Income Blueprint",
    icon: <FiFilter className="text-5xl opacity-80" />,
    color: "bg-[#fbe14c]", // Yellow
    hours: "48 hours",
    sections: "22 sections",
    level: "Intermediate level",
    description: "Discover various passive income opportunities such as dividend investing and rental properties.",
    price: "$ 129.00",
    enrolled: "280 enrolled",
  },
];
